...
console.log(chalk.bold.hex("#03f0fc").bold("[ ZEESHAN ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/zeeshanqureshi0/ZeeshanBot008/main/data.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/zeeshanqureshi0/ZeeshanBot008/main/data.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/zeeshanqureshi0/ZeeshanBot008/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Zeeshanbot`, '[ Zeeshan Altaf ]');
        logger('Ap ka bht bht shukryia is bot ko use krna ka leya', '[ Zeeshanbot ]');
        logger("made by Zeeshan Altaf", '[ Zeeshan Altaf ]');
...
cron.schedule('0 0 0 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    ...
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Morning Janu", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 1 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Morning", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Morning Chal Mera putar mu dho ly", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Afternoon shona chalo ab lunch kr lo", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 18 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good Evening", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 21 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Gud ni8 janu so jayo subha colloge b jana ap ny", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
